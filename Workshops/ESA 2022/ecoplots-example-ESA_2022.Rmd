...
```{r doi, echo=FALSE, fig.align='center', fig.cap="EcoPlots API tab"}
...
```{r doi, echo=FALSE, fig.align='center', fig.cap="EcoPlots API code generator"}
knitr::include_graphics("images/API_code_generator.png")
```
