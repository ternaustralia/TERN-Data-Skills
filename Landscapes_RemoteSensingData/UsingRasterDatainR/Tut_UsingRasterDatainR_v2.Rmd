...
* `stack`: Creates a RasterStack object from RasterLayer (i.e. individual layers) objects or from a multi-layer (band) file. They can also be created from a SpatialPixelsDataFrame object or SpatialGridDataFrame object. Individual raster layers must have the same spatial extent and resolution.

* `brick`: Creates a RasterBrick object from RasterLayer (i.e. individual layers) objects, a RasterStack, or from a multi-layer (band) file. They can also be created from SpatialPixels*, SpatialGrid*, and Extent objects. Individual raster layers must have the same spatial extent and resolution.
...
### Raster Calculations using Higher Level Functions in the package `raster`
