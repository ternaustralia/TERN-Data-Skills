...
This tutorial shows how to manipulate [EcoPlots's](https://ecoplots.tern.org.au/) plot ecological data downloads using R. This document uses the following libraries: `tidyverse`, `kablExtra`, `fs`, `easystats` and `bookdown` libraries.
